...
// ─────────────────────────────────────────────────────────────
const SL = {
  TP:"Turner & Price", S:"Sysco", B:"Brakes", AFS:"AFS",
...
const RAW = {
  // PRODUCE
  basil:        {n:"Basil Bunch",                    q:30,    u:"g",    p:{TP:1.79,S:2.03,B:1.59}},
  ...
  cherry_tom:   {n:"Cherry Tomato (250g)",           q:250,   u:"g",    p:{TP:1.49,S:0.82,B:0.99}},
  beef_tom:     {n:"Beef Tomato (ea ~250g)",         q:250,   u:"g",    p:{TP:0.79,S:0.72}},
  red_chilli:   {n:"Red Chilli (1kg)",               q:1000,  u:"g",    p:{TP:8.90,S:6.12}},
  chives:       {n:"Chives Bunch (100g)",            q:100,   u:"g",    p:{TP:1.49,S:2.03,B:1.59}},
  coriander:    {n:"Coriander Bunch (50g)",          q:50,    u:"g",    p:{TP:1.25,S:0.83,B:1.59,AC:1.09}},
  dill:         {n:"Dill Catering Bag (30g)",        q:30,    u:"g",    p:{TP:1.59,S:1.31,B:1.59,AC:1.09}},
  garlic:       {n:"Garlic Peeled (1kg)",            q:1000,  u:"g",    p:{TP:4.95,S:5.03,B:5.49,AC:4.79}},
  ...
  white_onion:  {n:"White Onion (2.5kg)",            q:2500,  u:"g",    p:{TP:3.75,S:1.78,B:3.74}},
  limes:        {n:"Limes x6 (~300g)",               q:300,   u:"g",    p:{TP:1.68,S:1.48,B:2.34}},
  mint:         {n:"Mint Bunch (30g)",               q:30,    u:"g",    p:{TP:1.45,S:1.30,B:1.59,AC:1.09}},
  ...
  spring_onion: {n:"Spring Onion Bunch (100g)",      q:100,   u:"g",    p:{TP:0.59,S:0.50,B:0.79}},
  sweet_potato: {n:"Sweet Potato (1kg)",             q:1000,  u:"g",    p:{TP:5.98,S:3.52,B:3.49,AC:3.19}},
  ...
  butter_s:     {n:"Butter Salted (250g)",           q:250,   u:"g",    p:{TP:2.20,S:2.42,B:1.79,AC:1.79}},
  ...
  // OILS & LIQUIDS
  mayo:         {n:"Mayonnaise (5L)",                q:5000,  u:"ml",   p:{TP:14.95,S:9.91,B:12.49}},
  ...
  lime_juice:   {n:"Lime Juice (1L)",                q:1000,  u:"ml",   p:{TP:4.00,S:2.58,B:3.29}},
  ...
  coconut_milk: {n:"Coconut Milk (1L)",               q:1000,  u:"ml",   p:{TP:2.60}},
  ...
  rice:         {n:"Rice (5kg)",                     q:5000,  u:"g",    p:{TP:12.99,S:13.14,B:12.29,AC:13.69}},
  plain_flour:  {n:"Plain Flour (1.5kg)",            q:1500,  u:"g",    p:{TP:1.70,S:1.72,B:1.29}},
  gram_flour:   {n:"Gram Flour (2kg)",               q:2000,  u:"g",    p:{TP:4.75,S:3.45,B:3.49}},
  ...
  arepa_flour:  {n:"Arepa Flour (1kg)",              q:1000,  u:"g",    p:{TP:2.30}},
  // SPICES & SEASONINGS
  table_salt:   {n:"Table/Sea Salt (1.4kg)",         q:1400,  u:"g",    p:{TP:14.99,S:12.50,B:13.99}},
  sm_paprika:   {n:"Smoked Paprika (1kg)",           q:1000,  u:"g",    p:{TP:10.50,S:9.73,B:11.00,AC:9.23}},
  ...
  jerk_seas:    {n:"Jerk Seasoning (1kg)",           q:1000,  u:"g",    p:{TP:12.00,B:10.75,AC:14.90}},
  ...
  cardamon:     {n:"Cardamon (1kg)",                 q:1000,  u:"g",    p:{TP:48.00,S:60.49,AC:56.45}},
  bay_leaves:   {n:"Bay Leaves (150g)",              q:150,   u:"g",    p:{TP:2.99,S:14.02,B:14.95,AC:7.17}},
  dark_choc:    {n:"Dark Chocolate Callets (2.5kg)", q:2500,  u:"g",    p:{TP:39.99,S:32.68,B:31.99}},
  ...
  chk_stock:    {n:"Chicken Stock Powder (800g)",    q:800,   u:"g",    p:{TP:22.99,S:19.62,B:13.29}},
  ...
  gran_sugar:   {n:"Granulated Sugar (2kg)",         q:2000,  u:"g",    p:{TP:3.00,S:3.16,B:2.49}},
  // EXTRAS
...
const BATCHES = {
  ...
  tomato_salsa:    {n:"Tomato Salsa",                   yield:2440,  yu:"g",      cat:"Bases",     ings:[r("cherry_tom",750,"g"),r("coriander",50,"g"),r("table_salt",10,"g"),r("blk_pepper",10,"g"),r("lime_juice",20,"ml"),r("beef_tom",2000,"g")]},
  ...
  pickled_onion:   {n:"Pickled Red Onion",              yield:800,   yu:"g",      cat:"Pickles",   ings:[r("red_onion",360,"g"),r("wine_vin",300,"ml"),r("cardamon",5,"g"),r("bay_leaves",1,"g"),r("gran_sugar",200,"g")]},
  pickled_cabbage: {n:"Pickled Red Cabbage",            yield:3600,  yu:"g",      cat:"Pickles",   ings:[r("red_cabbage",1800,"g"),r("wine_vin",1000,"ml"),r("cardamon",5,"g"),r("bay_leaves",1,"g"),r("gran_sugar",500,"g"),r("table_salt",5,"g")]},
...
const DISHES = {
  // SMALL PLATES
  viet_salad:    {n:"Vietnamese Salad",          cat:"Small Plates",    ings:[r("vermicelli",100,"g"),r("w_sesame",5,"g"),r("spring_onion",5,"g"),b("mojo",20,"ml")]},
  ...
  beef_croq_sm:  {n:"Beef Croquettes",           cat:"Small Plates",    ings:[b("chipotle_mayo",30,"ml"),b("beef_croquette_b",3,"portion"),b("chimichurri",15,"g"),r("peashoots",2,"g")]},
  // LUNCH
  beef_wrap:     {n:"Beef Wrap",                 cat:"Lunch",           ings:[b("pulled_beef",100,"g"),r("tortilla_6",1,"ea"),r("cheddar",20,"g"),r("iceberg",20,"g"),r("red_cabbage",10,"g"),b("tomato_salsa",20,"g"),b("chipotle_mayo",10,"ml")]},
  ...
  chk_wrap:      {n:"Chamo Chicken Wrap",        cat:"Lunch",           ings:[b("pulled_chicken",100,"g"),r("tortilla_6",1,"ea"),r("cheddar",20,"g"),r("iceberg",20,"g"),b("pickled_cabbage",10,"g"),b("tomato_salsa",20,"g"),b("chipotle_mayo",10,"ml")]},
  ...
  oy_mush_wrap:  {n:"Oyster Mushroom Wrap",      cat:"Lunch",           ings:[r("tortilla_6",1,"ea"),r("oyster_mush",100,"g"),r("iceberg",20,"g"),r("red_cabbage",20,"g"),b("tomato_salsa",45,"g"),r("vegan_mayo",10,"ml"),r("coriander",5,"g"),b("garlic_butter",10,"ml")]},
